    ...
    <div className="flex flex-col overflow-y-auto">
      <Description title="좋아하면 숭리는 개인정보처리방침">
        <div className="text-additive text-base font-medium leading-7 tracking-[-0.48px]">
          좋아하면 숭리는 운영진(이하 '운영진')은 정보주체의 자유와 권리 보호를
      ...
      <Description title="제2조 (개인정보 수집의 항목)">
        <p className="text-sm mb-2">
          ① 운영진은 다음의 개인정보 항목을 정보주체의 동의를 받아 처리하고
        ...
        <ul className="list-decimal pl-5 space-y-4 text-sm leading-relaxed">
          <li>
            ...
            <ul className="list-disc pl-5 mt-1 space-y-1">
              ...
              <li>
                운영진은 이용자의 편의를 위해 간편 로그인(카카오) 방식을
                제공하고 있습니다. 이와 같은 로그인시 본인확인 값만 비교할 뿐,
          ...
          <li>
            <strong>
              웹사이트 서비스 이용과정에서 이용자 행동 분석 및 서비스 개선을
              위해 아래와 같은 쿠키 정보들이 자동으로 생성되어 수집될 수
              있습니다.
            </strong>
            <ul className="list-disc pl-5 mt-1 space-y-1">
              <li>
      ...
      <Description title="제3조 (개인정보의 처리 및 보유기간)">
        <p className="text-sm mb-2">
          ① 운영진은 법령에 따른 개인정보 보유·이용 기간 또는 정보주체로부터
        ...
        <ul className="list-disc pl-5 space-y-2 text-sm leading-relaxed">
          <li>
            <strong>간편 로그인:</strong>회원탈퇴시까지. 또는 서비스 이용기간
            종료 후 7일
          </li>
          <li>
            <strong>위치 서비스 기반 매칭 서비스 제공:</strong> 회원탈퇴시까지.
            또는 서비스 이용기간 종료 후 7일
          </li>
          <li>
            <strong>이용자 행동 분석 및 서비스 개선:</strong> 회원탈퇴시까지.
            또는 서비스 이용기간 종료 후 7일
          </li>
          <li>
            <strong>
      ...
      <Description title="제4조 (개인정보의 파기 절차 및 방법)">
        <p className="text-sm mb-2">
          ① 운영진은 개인정보 보유기간의 경과, 서비스 이용계약 해지(탈퇴),
        ...
        <ul className="list-decimal pl-5 space-y-2 text-sm leading-relaxed">
          <li>
            <strong>파기절차:</strong> 운영진은 파기사유가 발생한 개인정보를
            선정하고, 운영진의 개인정보 보호책임자의 승인을 받아 개인정보를
            파기합니다.
          </li>
          <li>
            <strong>파기방법:</strong> 운영진은 전자적 파일 형태로 기록·저장된
      ...
      <Description title="제5조 (개인정보 처리의 위탁)">
        <p className="text-sm mb-2">
          ...
          내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을
          통하여 공개하도록 하겠습니다.
        </p>
        ...
        <ul className="list-disc pl-5 space-y-1 text-sm leading-relaxed">
          ...
          <li>
            <strong>이용 목적:</strong> 간편 결제(네이버페이, 삼성페이,
            카카오페이) 및 영수증 발송
          </li>
          <li>
            <strong>연락처:</strong>{" "}
        ...
        <p className="text-sm mt-4">
          이용자는 아래 제8조의 운영팀의 개인정보 보호책임자 및 담당 연락처를
          통해 개인정보의 국외 처리위탁을 거부할 수 있습니다. 이용자가
          개인정보의 국외 처리위탁을 거부하는 경우 운영팀은 해당 이용자의
          개인정보를 국외 처리위탁 대상에서 제외합니다.{" "}
          <span className="underline">
            {" "}
            다만, 이 경우 운영팀의 서비스 중 개인정보 국외 처리위탁이 필수적으로
            수반되는 서비스의 이용이 제한될 수 있습니다.
          </span>
        </p>
      </Description>
      ...
      <Description title="제6조 (개인정보의 안전성 확보조치)">
        <p className="text-sm mb-2">
          운영진은 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고
          있습니다.
        </p>
        <ul className="list-disc pl-5 space-y-1 text-sm leading-relaxed">
          <li>
          ...
          <li>
            <strong>기술적 조치:</strong> 개인정보처리시스템에 대한 등의 접근
            권한의 관리, 접속기록의 보관 및 점검, 개인정보처리시스템의 취약점
            점검 및 보완
          </li>
        </ul>
      </Description>
      ...
      <Description title="제7조 (개인정보 자동 수집 장치의 설치, 운영 및 거부)">
        <p className="text-sm mb-2">
          ① 운영진은 정보주체에게 개별적인 서비스와 편의를 제공하기 위해
        ...
        <p className="text-sm mb-2">
          ③ 정보주체는 브라우저 옵션 설정을 통해 쿠키 허용, 차단 등의 설정을 할
          수 있습니다.
        </p>
      ...
      <Description title="제8조 (개인정보 보호 책임자)">
        <p className="text-sm mb-2">
          ① 운영진은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
